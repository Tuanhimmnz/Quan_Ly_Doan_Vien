...
require_once __DIR__ . '/../functions/danhgia_functions.php'; // [FITDNU-ADD]
checkLogin(__DIR__ . '/../index.php');
$pageTitle = 'DNU - Khen thưởng / Kỷ luật';
require __DIR__ . '/../includes/header.php';

$params = ['q' => $_GET['q'] ?? '', 'trang_thai' => $_GET['trang_thai'] ?? ''];
$has = (trim($params['q']) !== '') || (trim($params['trang_thai']) !== '');
$danhgias = $has ? searchDanhGia($params) : getAllDanhGia();
?>

<div class="container mt-3 reveal-on-scroll">
  <div class="card reveal-on-scroll">
    <div class="card-header d-flex align-items-center justify-content-between">
      <h3 class="m-0">QUẢN LÝ KHEN THƯỞNG / KỶ LUẬT</h3>
      <a href="danhgia/create_danhgia.php" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Thêm quyết định</a>
    </div>
    <div class="card-body">
      <!-- [FITDNU-ADD] Tìm kiếm -->
      <form method="get" class="row g-2 mb-3">
        ...
        <div class="col-md-4 d-flex gap-2"><button class="btn btn-outline-primary btn-sm">Tìm kiếm</button><a href="danhgia.php" class="btn btn-outline-secondary btn-sm">Làm mới</a></div>
      </form>
      ...
      <table class="table table-striped table-hover align-middle">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?= htmlspecialchars($dg['loai']) ?></td>
      ...
      <div class="mt-2"><?= render_pagination('danhgia.php', $meta['page'], $meta['pages'], $_GET) ?></div>
      </div>
    </div>
  </div>
</div>
